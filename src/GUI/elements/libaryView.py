    ...
    books = [
        {
            ...
            'img': "src/assets/books/50_shades_of_grey.jpg",
            'Added': 2022-11-28,
        }, 
        {
            'name':"Steppenwolf",
            'img': "src/assets/books/steppenwolf_cover.jpg",
            'Added': 2022-11-28,
        },
        {
            'name':"Faust 1",
            'img': "src/assets/books/Goethe_Faust_I_und_II_und_Urfaust_v1_206024.jpg",
            'Added': 2022-11-28,
        },
    ]
